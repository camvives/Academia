...
<div style ="margin-left:155px" class="auto-style1">
...
<asp:ImageButton ID="btnEditar" runat="server" Height="26px" Width="80px" ImageUrl="~/Imagenes/editar.png" BorderStyle="Solid" BorderWidth="1px" OnClick="btnEditar_Click" />&nbsp&nbsp
